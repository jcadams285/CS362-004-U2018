...
int main (int argc, char** argv) {
    ...
    printf("\nRandom Card Test: Testing the Smithy card\n");
    printf("----------------------------------------------\n");
    ...
    for(int i = 0; i < NUMTESTS; i++){
        ...
        //Test 1- handcount should have 3 added cards - 1 played card
        if (state.handCount[player] != (stateOrg.handCount[player] + 2)){
    ...
    for(int i = 0; i < NUMTESTS; i++){
        ...
        //Play card
        cardEffect(smithy, choice1, choice2, choice3, &state, handPos, &bonus);
        //Deck card pile should have three less
